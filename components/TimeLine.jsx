    ...
    <div className="grid min-h-screen grid-cols-1 py-64 place-items-center place-content-center snap-center mx-w-5xl">
      ...
      >
        <div className="space-y-3">
          ...
          <h2 className="text-3xl">{useTranslation("Bio:student")}</h2>
        ...
        <p>{useTranslation("Bio:studentDescription")}</p>
      </motion.div>
      ...
      >
        <div className="space-y-3">
          ...
          <h2 className="text-3xl">{useTranslation("Bio:writer")}</h2>
        ...
        <p>{useTranslation("Bio:writerDescription")}</p>
      </motion.div>
      <motion.div
        initial={{ opacity: 0, scale: 0.5 }}
        whileInView={{ opacity: 1, scale: 1 }}
      ...
      >
        ...
        <p>{useTranslation("Bio:developer")}</p>
      </motion.div>
      {/* Future */}
      <motion.div
        initial={{ opacity: 0, scale: 0.5 }}
